...
### BSc Honours Computer Science *(In Progress)*  
**University of the Western Cape, South Africa**  
- Focus: Software Engineering  
- Project: Web Application Firewall (WAF)

---

### BSc Computer Science  
**University of the Western Cape, South Africa**  
- **Commencement:** 26 January 2023  
- **Completed:** 05 December 2025  
- **Coursework:**  
  Data Structures, Algorithms, Object-Oriented Programming, Computer Architecture,  
  Operating Systems, Databases, Software Engineering, Computer Networking,  
...
- **Tools & Technologies:** Git, GitHub, VS Code, Render, Aiven, Mailgun, Chart.js  
...
- Integrated **real-time data updates and interactive dashboards**  
- Deployed using **Render** with **Aiven (MySQL)**  
